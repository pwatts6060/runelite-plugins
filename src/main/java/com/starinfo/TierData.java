...
public class TierData
{
	private static final TierData[] data = new TierData[] {
		...
		new TierData(250, 2580, 0.3 * 255, 0.44 * 255, 31, 0.20),
		new TierData(175, 2755, 0.23 * 255, 0.3 * 255, 48, 0.30),
		new TierData(80, 2835, 0.15 * 255, 0.2 * 255, 74, 0.42),
		new TierData(40, 2875, 0.09 * 255, 0.13 * 255, 123, 0.56),
		new TierData(40, 2915, 0.07 * 255, 0.1 * 255, 162, 0.72),
		new TierData(15, 2930, 0.06 * 255, 0.07 * 255, 244, 0.90)
	};
